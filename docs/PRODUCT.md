...
> **Architecture note (2026-09-02):** the "Technical Architecture" section below
> describes the original Laravel + Blade monolith. The project is now **headless**
> — a Next.js frontend against a Laravel JSON API. See
> [ADR 0001](decisions/0001-headless-nextjs-laravel-architecture.md) and
> [Information Architecture](architecture/information-architecture.md). Product
> vision and the 7 practices are unchanged.
