        ...
        <div className="w-full lg:w-1/2 flex flex-col pt-4">
          <ScrollReveal delay={0.2}>
            ...
            <p className="text-[22px] leading-relaxed text-ink font-medium max-w-xl">
              Building an internal team used to be expensive and time-consuming. TeamBees solved our staffing needs globally, allowing us to scale our delivery teams seamlessly without any hiring or retention headaches.
            </p>
          </ScrollReveal>
        </div>
