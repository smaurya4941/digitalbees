          ...
          <ScrollReveal>
            <div className="w-full h-[400px] md:h-[600px] lg:h-[700px] relative rounded-[2rem] overflow-hidden shadow-lg">
              <Image
                ...
                alt="TeamBees team working in office"
                fill
              />
            </div>
          </ScrollReveal>
        ...
        <div className="w-full lg:w-[55%] flex flex-col justify-center">
          <ScrollReveal delay={0.1}>
            ...
            <h2 className="text-[32px] md:text-[44px] leading-[1.2] text-ink tracking-tight mb-6">
              At TeamBees, <span className="font-bold">we supply the people and we can run the work</span> — de-risking both hiring and delivery for the teams we partner with.
            </h2>
