...
export default function AboutCtaBand() {
  return (
    <section className="py-16 md:py-20 bg-surface-ivory border-b border-hairline" id="consultation">
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            <div className="lg:col-span-8 space-y-4">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-white tracking-tight leading-tight">
                Ready to unify your talent and engineering strategy?
              </h2>
              <p className="text-base sm:text-lg text-gray-300 max-w-2xl leading-relaxed">
                Discover how our integrated delivery model eliminates handoffs, unifies recruitment and delivery, and accelerates enterprise time-to-market.
              </p>
            </div>
