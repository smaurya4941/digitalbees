      ...
      <div className="w-full lg:w-[55%] py-12 lg:py-20 px-6 sm:px-8 lg:px-20 flex flex-col justify-center">
        <ScrollReveal delay={0.1}>
          ...
          <p className="text-[15px] text-gray-400 leading-relaxed mb-10 max-w-3xl">
            TeamBees Corp is the global talent-and-technology partner built to close the gap between hiring and delivery. Seven specialist practices — Talent, Digital, AI, Marketing, Quality, ServiceNow, and Energy Bees — working across six regions, so the team that finds your specialists is the same team that can help them ship.
          </p>
